...
con el precio del inmueble, donde el precio de un inmueble se calcula con las
siguiente fórmula en función de la zona:

Zona A: precio = (metros * 1000 + habitaciones * 5000 + garaje * 15000) * (1-antiguedad/100)
Zona B: precio = (metros * 1000 + habitaciones * 5000 + garaje * 15000) * (1-antiguedad/100) * 1.5'''

def buscador(lista,valor = 0):
    for i in dptos:
        if 'A' == i['zona']:
            precio = (i['metros'] * 1000 + i['habitaciones'] * 5000 + i["garaje"] * 15000) * (1 - ((2022 - i['año']) / 100))
            i['precio'] = round(precio,2)
        elif "B" == i['zona']:
            precio = (i['metros'] * 1000 + i['habitaciones'] * 5000 + i["garaje"] * 15000) * (1 - ((2022 - i['año']) / 100)) * 1.5
            i['precio'] = round(precio,2)
    resultados = []
    for i in dptos:
        if i['precio'] <= valor:
...
dptos = [{'año': 2000, 'metros': 100, 'habitaciones': 3, 'garaje': True, 'zona': 'A'},
{'año': 2012, 'metros': 60, 'habitaciones': 2, 'garaje': True, 'zona': 'B'},
{'año': 1980, 'metros': 120, 'habitaciones': 4, 'garaje': False, 'zona': 'A'},
{'año': 2005, 'metros': 75, 'habitaciones': 3, 'garaje': True, 'zona': 'B'},
{'año': 2015, 'metros': 90, 'habitaciones': 2, 'garaje': False, 'zona': 'A'}]
buscador(dptos,95000)
